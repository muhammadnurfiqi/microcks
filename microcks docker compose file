...
 
  keycloak:
    ...
    environment:
      ...
      KEYCLOAK_FRONTEND_URL: "https://mock.meetaza.com:18080/auth"
    volumes:
...
 
  app:
    ...
    environment:
      ...
      - KEYCLOAK_URL=https://mock.meetaza.com:8080/auth
      - KEYCLOAK_PUBLIC_URL=https://mock.meetaza.com:18080/auth
